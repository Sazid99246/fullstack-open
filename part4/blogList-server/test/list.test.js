...
describe("Most Liked Blog", () => {
  test("when list has only one blog, return that blog back", () => {
    const blogs = [
      {
        _id: "5a422aa71b54a676234d17f8",
        title: "Go To Statement Considered Harmful",
	...
	test("when list has no blogs, nothing should be returned", () => {
...
describe("Author who has the largest amount of blogs", () => {
  test("of empty list is {}", () => {
    ...
    assert.deepStrictEqual(resultEmptyBlogList, {})
  });
